                ...
                <div id="image">
                    <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 797.5 834.5"
                        ...
                        <path
                            ...
                            transform="translate(-201.25 -32.75)" fill="#2f2e41" />
                        <circle cx="559" cy="744.5" r="43" class="fill-detail" />
                        <circle cx="54" cy="729.5" r="43" class="fill-detail" />
                        <circle cx="54" cy="672.5" r="31" class="fill-detail" />
                        <circle cx="54" cy="624.5" r="22" class="fill-detail" />
                    </svg>
                </div>
            </div>
        </div>
